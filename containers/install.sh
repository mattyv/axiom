...
echo ""
echo "The LSP needs compile_commands.json to parse C++ code."
echo "Generate it with CMake:"
echo "  cmake -B build -DCMAKE_EXPORT_COMPILE_COMMANDS=ON"
echo ""
echo "Or create .axiom/config.toml in your project to specify the path:"
echo "  [extract]"
echo "  compile_commands = \"path/to/compile_commands.json\""
echo ""
